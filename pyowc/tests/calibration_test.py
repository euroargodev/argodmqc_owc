...
class UpdateSalinityMapping(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.python_output_path = os.path.sep.join(
            [
                TESTS_CONFIG["FLOAT_MAPPED_DIRECTORY"],
                TESTS_CONFIG["FLOAT_MAPPED_PREFIX"]
                + TESTS_CONFIG["TEST_FLOAT_SOURCE"]
                + TESTS_CONFIG["FLOAT_MAPPED_POSTFIX"],
            ]
        )
        matlab_output_path = os.path.sep.join(
            [
                TESTS_CONFIG["TEST_DIRECTORY"],
                "float_mapped_test",
                TESTS_CONFIG["FLOAT_MAPPED_PREFIX"]
                + TESTS_CONFIG["TEST_FLOAT_SOURCE"]
                + TESTS_CONFIG["FLOAT_MAPPED_POSTFIX"],
    ...
    def test_salinity_mapping(self):
        ...
        self.assertTrue("Using precalculated data" in captured_output.getvalue(), "Should use precalculated data !")
    ...
    def test_ptmp_output(self):
        ...
        self.assertAlmostEqual(
            test_mean,
            result_mean,
            self.acceptable_diff,
            "error: mean of potential temperatures differ " "between python and matlab",
        )
    ...
    def test_mapped_salerrors_output(self):
        ...
        self.assertAlmostEqual(
            ...
            result_mean,
            self.acceptable_diff,
            "error: mean of salinity errors " "differ between python andd matlab",
        )
    ...
    def test_noise_sal_output(self):
        ...
        self.assertAlmostEqual(
            ...
            result_mean,
            self.acceptable_diff,
            "error: mean of noise salinity " "differ between python andd matlab",
        )
...
class CalcPiecewiseFit(unittest.TestCase):
    ...
    def test_custom(self):
        ...
        test_data_path = os.path.sep.join(
            [
                TESTS_CONFIG["FLOAT_CALIB_DIRECTORY"],
        ...
        matlab_data_path = os.path.sep.join(
            [
                TESTS_CONFIG["TEST_DIRECTORY"],
                "float_calib_test",
                TESTS_CONFIG["FLOAT_CALIB_PREFIX"]
