...
class SpatialCorrelation(unittest.TestCase):
    ...
    def test_spatial_correlation_returns_array(self):
        ...
        sc_result = spatial_correlation_vec(
            hist_long,
            float_long,
            longitude_large,
            hist_lat,
    ...
    def test_spatial_correlation_returns_expected_float(self):
        ...
        age_large = 10
        phi_large = 0.1
        sc_result = utils.spatial_correlation(
            hist_long,
            float_long,
            longitude_large,
            hist_lat,
        ...
        pv_hist = -0.3 * 10**-7
        pv_float = -0.35 * 10**-7
        sc_pv_result = utils.spatial_correlation(
            hist_long,
            float_long,
            longitude_large,
            hist_lat,
    ...
    def test_spatial_correlation_returns_expected_array(self):
        ...
        for i in range(0, sc_expected.__len__()):
            self.assertEqual(round(sc_result[i], 4), sc_expected[i], "spatial_correlation arrays aren't equal")
...
class WrapLongitude(unittest.TestCase):
    ...
    def test_length_equal(self):
        ...
        self.assertTrue(long.__len__() == new_long.__len__(), "input and output should be equal in length")
