...
import unittest
import numpy as np
from .find_besthist import barotropic_potential_vorticity, spatial_correlation, find_ellipse
...
class FindBestHistTestCase(unittest.TestCase):
    ...
    def test_find_ellipse_returns_float(self):
        ...
        ellipse = find_ellipse(1, 1, 1, 1, 1, 1, 1, 1)
    ...
    def test_find_ellipse_returns_expected_float(self):
        ...
        ellipse = find_ellipse(53.195, 57.1794, 8,
                               -57.996, -59.1868, 4,
