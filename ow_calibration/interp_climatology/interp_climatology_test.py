...
class MyTestCase(unittest.TestCase):
    def test_something(self):
        grid_sal = np.array([[33.6620, 33.7630, 33.9060, 33.8380, 33.8650],
                             [33.6627, 33.7615, 33.9060, 33.8380, 33.8650],
                             [33.6625, 33.7630, 33.9060, 33.8380, 33.8660],
                             [33.6620, 33.7605, 33.9070, 33.8380, 33.8660],
                             [33.6623, 33.7620, 33.9065, 33.8390, 33.8660]])
        grid_theta = np.array([[1.2110, 5.4031, 3.8174, 5.0465, 4.7226],
